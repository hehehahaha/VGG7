...
#define IN_CH_NUM_Conv 3
#define IN_HEIGHT_Conv 32
#define IN_WIDTH_Conv 32

#define OUT_CH_NUM_Conv 128
#define OUT_HEIGHT_Conv 30
#define OUT_WIDTH_Conv 30

#define OUT_CH_NUM_Conv2 128
#define OUT_HEIGHT_Conv2 28
#define OUT_WIDTH_Conv2 28

#define OUT_CH_NUM_Conv3 256
#define OUT_HEIGHT_Conv3 12
#define OUT_WIDTH_Conv3 12

#define OUT_CH_NUM_Conv4 256
#define OUT_HEIGHT_Conv4 10
#define OUT_WIDTH_Conv4 10

#define OUT_CH_NUM_Conv5 512
#define OUT_HEIGHT_Conv5 3
#define OUT_WIDTH_Conv5 3

#define OUT_CH_NUM_Conv6 512
#define OUT_HEIGHT_Conv6 1
#define OUT_WIDTH_Conv6 1
...
static void init_arrays(haha *A, haha *W1, haha *conv1out, haha *gama1, haha *beta1, haha *burelu1out, haha *W2, haha *conv2out, haha *gama2, haha *beta2, haha *burelu2out, haha *pooling1out)//A输入， B卷积核1， D硬件输出， D_sw软件输出， W卷积核2
{
	...
	fp = fopen("E:/毕业论文/sdsoc code/Project2/mnt/inp.txt", "r");
	if (fp == NULL) {
	...
	fp1 = fopen("E:/毕业论文/sdsoc code/Project2/mnt/conv1.txt", "r");
	if (fp1 == NULL) {
	...
	fp2 = fopen("E:/毕业论文/sdsoc code/Project2/mnt/gama1.txt", "r");
	if (fp2 == NULL) {
	...
	fp3 = fopen("E:/毕业论文/sdsoc code/Project2/mnt/beta1.txt", "r");
	if (fp3 == NULL) {
	...
	fp4 = fopen("E:/毕业论文/sdsoc code/Project2/mnt/conv2.txt", "r");
	if (fp4 == NULL) {
	...
	fp5 = fopen("E:/毕业论文/sdsoc code/Project2/mnt/gama2.txt", "r");
	if (fp5 == NULL) {
	...
	fp6 = fopen("E:/毕业论文/sdsoc code/Project2/mnt/beta2.txt", "r");
	if (fp6 == NULL) {
...
static void init_arrays3(haha *W5, haha *conv5out, haha *gama5, haha *beta5, haha *burelu5out, haha *W6, haha *conv6out, haha *gama6, haha *beta6, haha *burelu6out, haha *D_sw3)//A输入， B卷积核1， D硬件输出， D_sw软件输出， W卷积核2
{
	//读取W5
	FILE *fp13;
	fp13 = fopen("E:/毕业论文/sdsoc code/Project2/mnt/conv5.txt", "r");
	if (fp13 == NULL) {
		printf("sadioj111111111gsaoig");
	}
	...
	fp14 = fopen("E:/毕业论文/sdsoc code/Project2/mnt/gama5.txt", "r");
	if (fp14 == NULL) {
		printf("sadiojg222222sao1ig");
	}
	...
	fp15 = fopen("E:/毕业论文/sdsoc code/Project2/mnt/beta5.txt", "r");
	if (fp15 == NULL) {
		printf("sadiojgs333333ao1ig");
	}
	for (int i = 0; i < OUT_CH_NUM_Conv5; i++) {
	...
	//读取W6
	FILE *fp16;
	fp16 = fopen("E:/毕业论文/sdsoc code/Project2/mnt/conv6.txt", "r");
	if (fp16 == NULL) {
		printf("sadiojgs4444444444ao1ig");
	}
	...
	fp17 = fopen("E:/毕业论文/sdsoc code/Project2/mnt/gama6.txt", "r");
	if (fp17 == NULL) {
		printf("sadio555555555jgs4aoig");
	}
	...
	fp18 = fopen("E:/毕业论文/sdsoc code/Project2/mnt/beta6.txt", "r");
	if (fp18 == NULL) {
		printf("sadioj666666gsao1ig");
	}
	for (int i = 0; i < OUT_CH_NUM_Conv6; i++) {
...
void conv1(haha *A, haha *W1, haha *conv1out) {
	...
	//{
		...
		memcpy((void*)tempB, W1, sizeof(haha) * OUT_CH_NUM_Conv * IN_CH_NUM_Conv * Conv_MAP_SIZE * Conv_MAP_SIZE);
		for (int kr = 0; kr < Conv_MAP_SIZE; kr++)//3
		{
			for (int kc = 0; kc < Conv_MAP_SIZE; kc++)//3
			{
				for (int r = 0; r < OUT_HEIGHT_Conv; r++)//30
				{
					...
					{
						for (int cho = 0; cho < OUT_CH_NUM_Conv; cho++)//128
						{
		...
		memcpy(conv1out, (const void*)tempconv1out, sizeof(haha) * OUT_CH_NUM_Conv * OUT_HEIGHT_Conv * OUT_WIDTH_Conv);
}
*/
...
void conv1(haha *A, haha *W1, haha *conv1out) {
	int times = 4;
	haha tempA[IN_CH_NUM_Conv][IN_HEIGHT_Conv][IN_WIDTH_Conv];
	haha tempB[OUT_CH_NUM_Conv / 4][IN_CH_NUM_Conv][Conv_MAP_SIZE][Conv_MAP_SIZE];
	haha tempconv1out[OUT_CH_NUM_Conv / 4][OUT_HEIGHT_Conv][OUT_WIDTH_Conv] = { 0 };
...
void bnrelu1(haha *conv1out, haha *gama1, haha *beta1, haha *burelu1out) {
	haha tempconv1out[OUT_CH_NUM_Conv / 8][OUT_HEIGHT_Conv][OUT_WIDTH_Conv];
	haha tempgama1[OUT_CH_NUM_Conv / 8];
	haha tempbeta1[OUT_CH_NUM_Conv / 8];
	haha tempbn1[OUT_CH_NUM_Conv /8][OUT_HEIGHT_Conv][OUT_WIDTH_Conv] = { 0 };
	//haha tempburelu1out[OUT_CH_NUM_Conv][OUT_HEIGHT_Conv][OUT_WIDTH_Conv] = { 0 };
	for (int cyc = 0; cyc < OUT_CH_NUM_Conv; cyc += OUT_CH_NUM_Conv / 8)
	{
		memcpy((void*)tempconv1out, conv1out + OUT_HEIGHT_Conv * OUT_WIDTH_Conv * cyc, sizeof(haha) * OUT_CH_NUM_Conv * OUT_HEIGHT_Conv * OUT_WIDTH_Conv / 8);
		memcpy((void*)tempgama1, gama1 + cyc, sizeof(haha) * OUT_CH_NUM_Conv / 8);
		memcpy((void*)tempbeta1, beta1 + cyc, sizeof(haha) * OUT_CH_NUM_Conv / 8);
		...
		memcpy(burelu1out + cyc * OUT_HEIGHT_Conv * OUT_WIDTH_Conv, (const void*)tempbn1, sizeof(haha) * OUT_CH_NUM_Conv * OUT_HEIGHT_Conv * OUT_WIDTH_Conv / 8);
...
void conv2(haha *burelu1out, haha *W2, haha *conv2out) {
	...
	haha tempW2[OUT_CH_NUM_Conv2 / 8][OUT_CH_NUM_Conv][Conv_MAP_SIZE][Conv_MAP_SIZE];
	haha tempconv2out[OUT_CH_NUM_Conv2 / 8][OUT_HEIGHT_Conv2][OUT_WIDTH_Conv2] = { 0 };

	for (int cyc = 0; cyc < OUT_CH_NUM_Conv2; cyc += OUT_CH_NUM_Conv2 / 8)
	{
		...
		memcpy((void*)tempW2, W2 + Conv_MAP_SIZE * Conv_MAP_SIZE * OUT_CH_NUM_Conv * cyc , sizeof(haha) * OUT_CH_NUM_Conv2 * OUT_CH_NUM_Conv * Conv_MAP_SIZE * Conv_MAP_SIZE /8);
		...
		for (int kr = 0; kr < Conv_MAP_SIZE; kr++)//3
		{
			for (int kc = 0; kc < Conv_MAP_SIZE; kc++)//3
			{
				for (int r = 0; r < OUT_HEIGHT_Conv2; r++)//28
				{
					...
					{
						for (int cho = 0; cho < OUT_CH_NUM_Conv2 / 8; cho++)//64
						{
		...
		memcpy(conv2out + cyc * OUT_HEIGHT_Conv2 * OUT_WIDTH_Conv2, (const void*)tempconv2out, sizeof(haha) * OUT_CH_NUM_Conv2 / 8 * OUT_HEIGHT_Conv2 * OUT_WIDTH_Conv2);
...
void bnrelu2(haha *conv2out, haha *gama2, haha *beta2, haha *burelu2out) {
	haha tempconv2out[OUT_CH_NUM_Conv2 / 8][OUT_HEIGHT_Conv2][OUT_WIDTH_Conv2];
	//haha tempburelu2out[OUT_CH_NUM_Conv2][OUT_HEIGHT_Conv2][OUT_WIDTH_Conv2] = { 0 };
	haha tempgama2[OUT_CH_NUM_Conv2 / 8];
	haha tempbeta2[OUT_CH_NUM_Conv2 / 8];
	haha tempbn2[OUT_CH_NUM_Conv2 / 8][OUT_HEIGHT_Conv2][OUT_WIDTH_Conv2] = { 0 };
	for (int cyc = 0; cyc < OUT_CH_NUM_Conv2; cyc += OUT_CH_NUM_Conv2 / 8)
	{
		memcpy((void*)tempconv2out, conv2out + OUT_HEIGHT_Conv2 * OUT_WIDTH_Conv2 * cyc, sizeof(haha) * OUT_CH_NUM_Conv2 * OUT_HEIGHT_Conv2 * OUT_WIDTH_Conv2 / 8);
		memcpy((void*)tempgama2, gama2 + cyc, sizeof(haha) * OUT_CH_NUM_Conv2 / 8);
		memcpy((void*)tempbeta2, beta2 + cyc, sizeof(haha) * OUT_CH_NUM_Conv2 / 8);
		...
		memcpy(burelu2out + cyc * OUT_HEIGHT_Conv2 * OUT_WIDTH_Conv2, (const void*)tempbn2, sizeof(haha) * OUT_CH_NUM_Conv2 * OUT_HEIGHT_Conv2 * OUT_WIDTH_Conv2 / 8);
		/*for (int i = 0; i < OUT_CH_NUM_Conv2 / 8; i++) {
			for (int j = 0; j < OUT_HEIGHT_Conv2; j++) {
				for (int k = 0; k < OUT_WIDTH_Conv2; k++) {
...
void conv5(haha *pooling2out, haha *W5, haha *conv5out) {
	...
	haha tempW5[OUT_CH_NUM_Conv5 / 64][OUT_CH_NUM_Conv4][Conv_MAP_SIZE][Conv_MAP_SIZE];
	haha tempconv5out[OUT_CH_NUM_Conv5 / 64][OUT_HEIGHT_Conv5][OUT_WIDTH_Conv5] = { 0 };
	...
	for (int cyc = 0; cyc < OUT_CH_NUM_Conv5; cyc += OUT_CH_NUM_Conv5 / times)
	{
		...
		/*for (int i = 0; i < OUT_CH_NUM_Conv5/times; i++) {
			for (int j = 0; j < OUT_CH_NUM_Conv4; j++) {
				for (int k = 0; k < Conv_MAP_SIZE; k++) {
					for (int l = 0; l < Conv_MAP_SIZE; l++) {
						printf("%f ", tempW5[i][j][k][l]);
					}
				}
			}
		}*/
...
void bnrelu5(haha *conv5out, haha *gama5, haha *beta5, haha *burelu5out) {
	haha tempconv5out[OUT_CH_NUM_Conv5 / 16][OUT_HEIGHT_Conv5][OUT_WIDTH_Conv5];
	haha tempgama5[OUT_CH_NUM_Conv5 / 16];
	haha tempbeta5[OUT_CH_NUM_Conv5 / 16];
	haha tempbn5[OUT_CH_NUM_Conv5 / 16][OUT_HEIGHT_Conv5][OUT_WIDTH_Conv5] = { 0 };
	//haha tempburelu1out[OUT_CH_NUM_Conv][OUT_HEIGHT_Conv][OUT_WIDTH_Conv] = { 0 };
	for (int cyc = 0; cyc < OUT_CH_NUM_Conv5; cyc += OUT_CH_NUM_Conv5 / 16)
	{
		memcpy((void*)tempconv5out, conv5out + OUT_HEIGHT_Conv5 * OUT_WIDTH_Conv5 * cyc, sizeof(haha) * OUT_CH_NUM_Conv5 * OUT_HEIGHT_Conv5 * OUT_WIDTH_Conv5 / 16);
		memcpy((void*)tempgama5, gama5 + cyc, sizeof(haha) * OUT_CH_NUM_Conv5 / 16);
		memcpy((void*)tempbeta5, beta5 + cyc, sizeof(haha) * OUT_CH_NUM_Conv5 / 16);

		for (int i = 0; i < OUT_CH_NUM_Conv5 / 16; i++) {
			for (int j = 0; j < OUT_HEIGHT_Conv5; j++) {
				for (int k = 0; k < OUT_WIDTH_Conv5; k++) {
		...
		memcpy(burelu5out + cyc * OUT_HEIGHT_Conv5 * OUT_WIDTH_Conv5, (const void*)tempbn5, sizeof(haha) * OUT_CH_NUM_Conv5 * OUT_HEIGHT_Conv5 * OUT_WIDTH_Conv5 / 16);
...
void conv6(haha *burelu5out, haha *W6, haha *conv6out) {
	...
	haha tempW6[OUT_CH_NUM_Conv6 / 16][OUT_CH_NUM_Conv5][Conv_MAP_SIZE][Conv_MAP_SIZE];
	haha tempconv6out[OUT_CH_NUM_Conv6 / 16][OUT_HEIGHT_Conv6][OUT_WIDTH_Conv6] = { 0 };
...
void bnrelu6(haha *conv6out, haha *gama6, haha *beta6, haha *D_sw3) {
	haha tempconv6out[OUT_CH_NUM_Conv6 / 16][OUT_HEIGHT_Conv6][OUT_WIDTH_Conv6];
	haha tempgama6[OUT_CH_NUM_Conv6 / 16];
	haha tempbeta6[OUT_CH_NUM_Conv6 / 16];
	haha tempbn6[OUT_CH_NUM_Conv6 / 16][OUT_HEIGHT_Conv6][OUT_WIDTH_Conv6] = { 0 };
	//haha tempburelu1out[OUT_CH_NUM_Conv][OUT_HEIGHT_Conv][OUT_WIDTH_Conv] = { 0 };
	for (int cyc = 0; cyc < OUT_CH_NUM_Conv6; cyc += OUT_CH_NUM_Conv6 / 16)
	{
		memcpy((void*)tempconv6out, conv6out + OUT_HEIGHT_Conv6 * OUT_WIDTH_Conv6 * cyc, sizeof(haha) * OUT_CH_NUM_Conv6 * OUT_HEIGHT_Conv6 * OUT_WIDTH_Conv6 / 16);
		memcpy((void*)tempgama6, gama6 + cyc, sizeof(haha) * OUT_CH_NUM_Conv6 / 16);
		memcpy((void*)tempbeta6, beta6 + cyc, sizeof(haha) * OUT_CH_NUM_Conv6 / 16);
		...
		memcpy(D_sw3 + cyc * OUT_HEIGHT_Conv6 * OUT_WIDTH_Conv6, (const void*)tempbn6, sizeof(haha) * OUT_CH_NUM_Conv6 * OUT_HEIGHT_Conv6 * OUT_WIDTH_Conv6 / 16);
...
int main(int argc, char* argv[]) {
	...
	if (!A || !W1 || !gama1 || !beta1 || !W2 || !gama2 || !beta2 || !pooling1out) {
		...
		if (gama2) free(gama2);
		if (beta2) free(beta2);
		if (pooling1out) free(pooling1out);
		return 2;
	}
	...
	if (!W3 || !gama3 || !beta3 || !W4 || !gama4 || !beta4 || !pooling2out) {
		...
		if (gama4) free(gama4);
		if (beta4) free(beta4);
		if (pooling2out) free(pooling2out);
		return 2;
	}
